...
class LocationsPage extends StatefulWidget {
    LocationsPage({Key? key, Title? title}) : super(key: key);
    final String title = '';
    static const String page_id = 'Locations';
                                            ...
                                            child: InkWell(
                                                ...
                                                child: Column(
                                                    children: [
                                                        ...
                                                        Text('To get estimation please enter the drop off location',
