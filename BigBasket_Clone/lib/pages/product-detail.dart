...
class _ProductDetailPageState extends State<ProductDetailPage> {
  List<String> addresses = ['Home', 'Office'];
  int _current = 0;
  ...
  List<Item> products = <Item>[
    Item('assets/images/pro_1.jpg', 'Testies - Nacho Chips - Jalapeno', '\$90',
        '\$45'),
    Item(
        'assets/images/pro_2.jpg', 'BB Popular - Almond/Badam', '\$90', '\$45'),
    Item('assets/images/pro_3.jpg', 'Testies - Nacho Chips - Cheese', '\$90',
        '\$45'),
    Item('assets/images/pro_4.jpg', 'BB Royal - Cardamom Green/Elakki', '\$90',
        '\$45'),
    Item('assets/images/pro_5.jpg', 'BORGES - Extra Virgin Olive Oil', '\$90',
        '\$45'),
    Item('assets/images/pro_6.jpg', 'BORGES - Extra Virgin Olive Oil', '\$90',
        '\$45'),
    Item('assets/images/pro_7.jpg', 'BB Royal - Idli - Sooji', '\$90', '\$45'),
    Item('assets/images/pro_8.jpg', 'BB Home - Spin Mop Bucket-360', '\$90',
        '\$45'),
  ];
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      'See more BB Popular products',
                      style: TextStyle(fontFamily: 'medium'),
                    ),
                  ),
                  Text(
                    'Toor/Arhar Dal, 1kg - Pouch',
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Center(
                        child:
                            Image.asset('assets/images/rating.png', width: 150),
                      ))
                ],
              ),
            ),
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Text(
                            'View more products from Toor, Chana & Moong dal'
                                .toUpperCase()),
                      )),
                      Container(
                        height: 80,
                      ...
                      Container(
                        ...
                        child: Center(
                          child: Text(
                            'B',
                            style: TextStyle(
                                fontSize: 30, fontFamily: 'semi-bold'),
                          ),
                        ),
                      ),
                      Expanded(
                        ...
                        padding: EdgeInsets.symmetric(horizontal: 12),
                        child: Text(
                            'View more products from bbpopular'.toUpperCase()),
                      )),
                      Container(
                        height: 80,
                        width: 36,
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    'More about the product from Brand',
                    style: TextStyle(fontSize: 18),
                  ),
                  SizedBox(height: 16),
                  Divider(
                  ...
                  Padding(
                    ...
                    child: Text(
                      'BB Popular Toor Dal - Big quality, Small Price.',
                      style: titleLabel(),
                    ),
                  ),
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Illo ratione odio eos aspernatur labore molestias totam. Possimus, tempore laboriosam similique, quos adipisci praesentium autem temporibus explicabo consequatur non ab neque?',
                      style: smallLabel()),
                  SizedBox(height: 16),
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Repudiandae id quaerat quibusdam ducimus nostrum voluptatum, tempora voluptates velit vero numquam! Assumenda, velit! Quam explicabo enim dolores sint ullam eaque odio.',
                      style: smallLabel()),
                  SizedBox(height: 16),
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nemo, eaque facere.',
                      style: smallLabel()),
                  SizedBox(height: 16),
                  Text(
                      'Labore odio quae id esse voluptates saepe eos animi amet, blanditiis numquam molestias veniam in vero, sed ipsa asperiores?',
                      style: smallLabel()),
                  SizedBox(height: 16),
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Optio totam culpa quos, necessitatibus maiores deleniti veniam quo ullam dolorum itaque nostrum dolorem saepe omnis adipisci fugit dicta a aut molestiae.',
                      style: smallLabel()),
                  SizedBox(height: 16),
                  ...
                  SizedBox(height: 16),
                  Text(
                      'Dolor, vitae et nemo tempore doloribus enim dolore optio, reiciendis velit sunt ipsum veniam sequi quis, neque laboriosam! Accusamus sit consequatur necessitatibus!',
                      style: smallLabel()),
                  SizedBox(height: 16),
                ],
              ),
...
//
  ...
  boldLabel() {
    return TextStyle(fontSize: 15, fontFamily: 'semi-bold');
  }
