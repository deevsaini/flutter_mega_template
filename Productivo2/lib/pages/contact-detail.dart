                                        ...
                                        children: [
                                            ...
                                            Column(
                                                children: [
                                                  ...
                                                  SizedBox(height: 16),
                                                  Text('Conversation can be a tricky business. Sometimes, decoding what is said with what is meant is difficult at best.',
                                      ...
                                      children: [
                                          ...
                                          Row(
                                              children: [
                                                  ...
                                                  SizedBox(width: 8),
                                                  Icon(Icons.keyboard_arrow_down, color: style.appGrey),
                                              ],
                                          ),
                                      ],
                                  ),
                                                ...
                                                child: Row(
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Text(tasks[index].detail,
                                                        style: TextStyle(
                                                            color: tasks[index].clr2
                                                        ),
                                                      ),
                                                    ),
                                                  ],
